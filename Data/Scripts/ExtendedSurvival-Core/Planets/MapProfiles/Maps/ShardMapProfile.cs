...
{
    public static class ShardMapProfile
    {

        public const ulong SAFINA_MODID = 2157163302;

        public const string DEFAULT_SAFINA = "SAFINAV2";
        public const string DEFAULT_THANIAN = "THANIAN";
        public const string DEFAULT_RISHA = "RISHA";

        public const string SafinaWater = "SafinaWater";

        public const string SafinaSand = "SafinaSand";
        public const string SafinaRedSand = "SafinaRedSand";
        public const string SafinaLakebed = "SafinaLakebed";
        
        public const string ThanianSoil = "ThanianSoil";

        public const string RishaSoil = "RishaSoil";

        static ShardMapProfile()
        {
            LoadSafinaOreMapInfo();
            LoadThanianOreMapInfo();
            LoadRishaOreMapInfo();
            SAFINA.Ores = VanilaMapProfile.PERTAM_ORES;
            THANIAN.Ores = VanilaMapProfile.MOON_ORES;
            RISHA.Ores = VanilaMapProfile.MOON_ORES;
        }

        private static void LoadRishaOreMapInfo()
        {
            ...
            PlanetOreMapProfile.PLANET_OREMAP_INFO[DEFAULT_RISHA] = mapInfo;
        }

        private static void LoadThanianOreMapInfo()
        {
            var mapInfo = new PlanetOreMapProfile.PlanetOreMapInfo();
            ...
            PlanetOreMapProfile.PLANET_OREMAP_INFO[DEFAULT_THANIAN] = mapInfo;
        }

        private static void LoadSafinaOreMapInfo()
        {
            var mapInfo = new PlanetOreMapProfile.PlanetOreMapInfo();
            ...
            PlanetOreMapProfile.PLANET_OREMAP_INFO[DEFAULT_SAFINA] = mapInfo;
        }

        public static readonly PlanetProfile SAFINA = new PlanetProfile()
        {
            Origin = PlanetProfile.PlanetOrigin.OtherMod,
            OriginId = SAFINA_MODID,
            ...
            Temperature = PlanetMapProfile.GetTemperature(VRage.Game.MyTemperatureLevel.Hot, 5, 45),
        ...
        public static readonly PlanetProfile THANIAN = new PlanetProfile()
        {
            ...
            Atmosphere = PlanetMapProfile.GetAtmosphere(true, false, 0.5f, 0.0f, 5, 1.0f, 0.25f, 0),
            Gravity = PlanetMapProfile.GetGravity(0.32f, 7.0f),
            Temperature = PlanetMapProfile.GetTemperature(VRage.Game.MyTemperatureLevel.Freeze, -30, 10),
            Water = PlanetMapProfile.GetWater(false),
        ...
        public static readonly PlanetProfile RISHA = new PlanetProfile()
        {
            ...
            Gravity = PlanetMapProfile.GetGravity(0.10f, 7.0f),
