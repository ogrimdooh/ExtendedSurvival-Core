...
namespace ExtendedSurvival.Core
{
    ...
    public static class SamMapProfile
    {
        ...
        {
            HELIOSTERRAFORMED_ORES = PlanetMapProfile.BuildOreMap(
                new string[]
                {
            ...
            HELIOSTERRAFORMED.Ores = HELIOSTERRAFORMED_ORES;
        }
        ...
        // Ore Maps
        public static List<PlanetProfile.OreMapInfo> HELIOSTERRAFORMED_ORES;
