...
namespace ExtendedSurvival.Core
{
    public static class MLTModsMapProfile
    {
        ...
        {
            SEDONIA_ORES = PlanetMapProfile.BuildOreMap(
                new string[]
                {
            ...
            SEDONIA.Ores = SEDONIA_ORES;
            IRENE1C_ORES = PlanetMapProfile.BuildOreMap(
                new string[]
                {
                    PlanetMapProfile.Iron_02,
                    PlanetMapProfile.Nickel_01,
        ...
        // Ore Maps
        public static List<PlanetProfile.OreMapInfo> SEDONIA_ORES;
        public static List<PlanetProfile.OreMapInfo> IRENE1C_ORES;
