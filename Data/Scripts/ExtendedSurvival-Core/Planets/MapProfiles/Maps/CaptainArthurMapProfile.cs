...
namespace ExtendedSurvival.Core
{
    public static class CaptainArthurMapProfile
    {
        ...
        {
            CRAIT_ORES = PlanetMapProfile.BuildOreMap(
                new string[]
                {
            ...
            CRAIT.Ores = CRAIT_ORES;
            PLANET26_ORES = PlanetMapProfile.BuildOreMap(
                new string[]
                {
                    PlanetMapProfile.Iron_02,
                    PlanetMapProfile.Nickel_01,
        ...
        // Ore Maps
        public static List<PlanetProfile.OreMapInfo> CRAIT_ORES;
        public static List<PlanetProfile.OreMapInfo> PLANET26_ORES;
